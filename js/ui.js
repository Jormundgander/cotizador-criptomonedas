class RenderUI {
    ...
    renderFilteredData(data, realCoin, cryptoCoin) {
        ...
        const ultimaActualizacion = new Date(info.LASTUPDATE * 1000).toLocaleDateString('es-VE')
        ...
        const templateHTML = `
            ...
            >
                <div class="card-body text-white">
                    ...
                    <p>El precio de la criptomoneda ${info.TOSYMBOL} en ${info.FROMSYMBOL} es de: ${info.PRICE.toFixed(2)}</p>
